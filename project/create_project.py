#!/usr/bin/env python3
"""
Project creation automation script that creates new projects based on YAML configurations.
This script handles YAML parsing, project directory creation, template copying,
conda environment setup, and git repository initialization.
"""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Create a new project from YAML configuration"
    )
