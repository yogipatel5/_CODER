"""Admin configuration for adwords app."""
...
from adwords.models import Task, TaskError
...
# Register ManagerAccount with custom adm   in
...
for module_name in admin_files:
    try:
        importlib.import_module(f"adwords.admin.{module_name}")
