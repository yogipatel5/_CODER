...
class ShipperAPIException(Exception):
    """Base exception for Shipper API errors"""
...
class BadRequestError(ShipperAPIException):
    """400 Bad Request"""
...
class UnauthorizedError(ShipperAPIException):
    """401 Unauthorized"""
...
def raise_for_status_code(response_data: Dict[str, Any]) -> None:
    ...
    error_class = error_map.get(code, ShipperAPIException)
