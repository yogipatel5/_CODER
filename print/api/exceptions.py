...
class PrintAPIException(Exception):
    """Base exception for Print API errors"""
...
class BadRequestError(PrintAPIException):
    """400 Bad Request"""
...
class UnauthorizedError(PrintAPIException):
    """401 Unauthorized"""
...
def raise_for_status_code(response_data: Dict[str, Any]) -> None:
    ...
    error_class = error_map.get(code, PrintAPIException)
